...
export class GetBalance {
  ...
  getBalance = async (data: IGetCategory) => {
    ...
    try {
      const response = await axios.post(this.cfg.domain_url + '/share/GetInfo/get-Balance', data, {
        headers,
      })
      ...
      if (error.response) {
        console.log('get Balance VTC response = \n', error.response.data)
        ...
        console.log('get Balance VTC Error message = \n', error.message)
        return {
