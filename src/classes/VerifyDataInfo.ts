...
import { IverifyDataInfo } from '../interfaces/requestvtc.interface'

export class VerifyDataInfo {
  getDataInfo = (data: IverifyDataInfo) => {
    // const dataInfo =
    ...
    const TripleDESKey = data.tripleDesKey
    ...
    let encrypted = decipher.update(data.dataInfo, 'base64', 'utf8')
